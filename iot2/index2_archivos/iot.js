...
function recorreRecursiva(context){
//    console.log("$('div.cuadrado', context).length");
//    console.log($('div.cuadrado', context).length);
//    if ($('div.cuadrado', context).length>0){
//        $('div.cuadrado', context).each(function(){
